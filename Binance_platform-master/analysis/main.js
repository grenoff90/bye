      ...
      charts.forEach((chart) => {
        ...
        if (chart.data.datasets[0].label == 'Cumulative PNL(%)')
        {
          if (chart.data.datasets[0].data.length > 20)
          {
            ...
            chart.data.datasets[0].data.push(1-2.25, 2.59, 22.1, 1.93, 33.5, 6.79, 7.66, 7.95 , 19.3, 22.11, 24.17, 22.93, 21.99, 22.67, 24.27, 24.9, 24.69, 27.5, 25.76, 23.71, 30, 36, 0);
        ...
        }else if (chart.data.datasets[0].label == "Daily PNL")
        {
          ...
          chart.data.datasets[0].data.push(8.2, -6.3, 17.40, 18.73, -1.5, 24.68, 17.72, 18.6 , 56.6, 41.6, -6.8, -10.31, 2.1, 36.6, 28.2, 33.5, -21.5, 16.8);
        }
        else {
          if (chart.data.datasets[0].data.length > 20)
          {
